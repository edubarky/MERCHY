    ...
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative z-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:relative lg:mt-[75px] lg:min-h-[437px]">
          ...
          <div
            id="ctc-panel"
            className="relative rounded-[18px] border border-[#EBECEF] bg-[#F9FAFB] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-8 lg:rounded-none lg:border-0 lg:bg-transparent lg:shadow-none lg:absolute lg:p-12 lg:-top-[114px] lg:left-[30px] lg:w-[998px] lg:h-[447px] lg:origin-top-left lg:scale-[1.22]"
          >
            {/* Mobile / tablet: composición original en flujo normal */}
            <div className="contents lg:hidden">
      ...
      <footer className="relative bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10 lg:min-h-[564px]">
          ...
          <div id="ftr-content" className="hidden lg:block absolute" style={{ top: "64px", left: "32px", width: "1216px", height: "460px" }}>
            ...
            <p className="absolute text-xs text-ui-gray text-center" style={{ top: "353px", left: "32px", width: "1235px", height: "105px" }}>© 2026 Merchy. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </main>
