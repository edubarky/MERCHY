          ...
          >
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center gap-5 p-8 text-center">
              ...
              <div className="w-full text-center">
                ...
                <div className="mx-auto mt-3 h-1.5 w-12 rounded-full bg-primary" />
                <p className="mt-4 text-sm text-ui-gray">Explora todo nuestro catálogo de productos</p>
              </div>
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-white text-accent-coral transition-transform group-hover:scale-105 shadow-[0_12px_30px_rgba(0,0,0,0.14)]">
