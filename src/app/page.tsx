  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="relative grid items-stretch lg:grid-cols-2 gap-6">
          {/* Teal card */}
          <div className="bg-gradient-to-br from-primary to-primary-dark rounded-none p-10 flex flex-col justify-between min-h-[260px] lg:min-h-[388px]">
          ...
          {/* Lo que ofrecemos */}
          <div id="ofrecemos-box" className="bg-white rounded-none p-10 flex flex-col border border-ui-border lg:absolute lg:top-[20px] lg:left-[570px] lg:w-[640px] lg:h-[410px]">
