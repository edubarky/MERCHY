          ...
          {STATIC_CATEGORIES.map((cat) => (
            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col p-8">
                ...
                <div className="relative flex flex-1 items-end justify-center px-4">
                  <div className="absolute inset-x-10 bottom-8 h-48 rounded-full bg-teal-100/70 blur-2xl" />
                  <div className="absolute right-0 top-1/3 h-24 w-24 -translate-y-1/2 rounded-full bg-teal-50 opacity-70 blur-2xl" />
                  <div className="relative z-10 w-full max-w-[260px]">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={cat.asset} alt={`${cat.name} category`} className="w-full h-[280px] object-contain object-bottom" />
                  </div>
