            ...
            >
              ...
              {cat.slug === "bebidas" ? (
                <>
                  ...
                  <span
                    className="group/btn absolute left-1/2 z-20 flex -translate-x-1/2 items-center justify-center gap-2.5 overflow-hidden rounded-full bg-gradient-to-r from-primary to-primary-dark text-white text-lg font-semibold shadow-[0_18px_35px_rgba(30,203,194,0.28)] transition-shadow duration-[1100ms] ease-[cubic-bezier(0.65,0,0.35,1)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.10),inset_0_1px_0_rgba(255,255,255,0.20),inset_0_0_0_1px_rgba(255,255,255,0.14)]"
                  ...
                  >
                    ...
                    <span
                      aria-hidden="true"
                      className="pointer-events-none absolute inset-y-0 z-0 translate-x-full transition-transform duration-[1100ms] ease-[cubic-bezier(0.65,0,0.35,1)] group-hover/btn:translate-x-0"
                      style={{
                        left: "-190px",
                    ...
                    <span
                      aria-hidden="true"
                      className="pointer-events-none absolute inset-0 z-[1] opacity-0 transition-opacity duration-[1100ms] ease-[cubic-bezier(0.65,0,0.35,1)] group-hover/btn:opacity-100"
                      style={{
                        background:
                    ...
                    <span className="relative z-10 inline-flex flex-none items-center justify-center">
                      {/* círculo del icono: turquesa translúcido en normal, coral sólido en hover */}
                      <span
                        aria-hidden="true"
                        className="pointer-events-none absolute rounded-full bg-primary-dark/40 transition-colors duration-[1100ms] ease-[cubic-bezier(0.65,0,0.35,1)] group-hover/btn:bg-accent-coral"
                        style={{ width: "34px", height: "34px", left: "50%", top: "50%", transform: "translate(-50%, -50%)" }}
                      />
                      <svg className="relative w-6 h-6" viewBox="0 0 21.44 27.48" fill="none" xmlns="http://www.w3.org/2000/svg">
