            ...
            >
              ...
              {cat.slug === "bebidas" ? (
                <>
                  ...
                  <span
                    className="group/btn absolute left-1/2 z-20 flex -translate-x-1/2 items-center justify-center gap-2.5 rounded-full bg-gradient-to-r from-primary to-primary-dark text-white text-lg font-semibold shadow-[0_18px_35px_rgba(30,203,194,0.28)]"
                  ...
                  >
                    ...
                    <span className="relative inline-flex flex-none items-center justify-center">
                      {/* anillo de progreso coral: se dibuja alrededor de la mano al entrar en hover, usando stroke-dasharray/stroke-dashoffset */}
                      <svg
                        className="pointer-events-none absolute left-1/2 top-1/2"
                        style={{ width: "34px", height: "34px", transform: "translate(-50%, -50%) rotate(-90deg)" }}
                        viewBox="0 0 34 34"
                        fill="none"
                      >
                        <circle
                          ...
                          pathLength="100"
                          strokeDasharray="100"
                          className="[stroke-dashoffset:100] transition-[stroke-dashoffset] duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/btn:[stroke-dashoffset:0]"
                        />
                      </svg>
