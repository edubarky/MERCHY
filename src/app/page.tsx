            ...
            >
              ...
              {cat.slug === "bebidas" ? (
                <>
                  ...
                  <span
                    className="group/btn absolute left-1/2 z-20 flex -translate-x-1/2 items-center justify-center gap-2.5 rounded-full bg-gradient-to-r from-primary to-primary-dark text-white text-lg font-semibold shadow-[0_18px_35px_rgba(30,203,194,0.28)] transition-shadow duration-[280ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:shadow-[0_18px_35px_rgba(30,203,194,0.28),0_0_26px_4px_rgba(87,224,217,0.35)]"
                    style={{ bottom: "21px", width: "222px", height: "52px" }}
                  >
                    <span className="pointer-events-none absolute inset-0 rounded-full bg-gradient-to-r from-[#6ceee6] to-[#23c9bf] opacity-0 transition-opacity duration-[280ms] ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/btn:opacity-100" />
                    <span className="relative">
                      Explorar
                      <span className="pointer-events-none absolute left-1/2 top-full mt-[3px] h-[2px] w-0 -translate-x-1/2 rounded-full bg-accent-coral opacity-0 transition-all duration-[280ms] ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/btn:w-7 group-hover/btn:opacity-100" />
                    </span>
                    <svg className="relative w-6 h-6 flex-none transition-transform duration-[280ms] ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/btn:translate-x-[3px]" viewBox="0 0 21.44 27.48" fill="none" xmlns="http://www.w3.org/2000/svg">
