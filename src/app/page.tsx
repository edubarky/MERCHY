            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col p-8">
                ...
                <div className="relative flex flex-1 items-center justify-center">
                  <div className="absolute inset-x-6 bottom-4 h-56 rounded-full bg-teal-100/60 blur-3xl" />
                  <div className="absolute right-2 top-2 h-28 w-28 rounded-full bg-teal-50 opacity-70 blur-2xl" />
                  <div className="absolute left-2 bottom-10 h-24 w-24 rounded-full bg-teal-100/50 blur-2xl" />

                  <div className="relative z-10 w-[80%] max-w-[230px]">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
