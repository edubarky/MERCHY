...
export default function SelectionToolbar({
  ...
  return (
    // El panel de "Opciones de diseño" (más abajo) ya NO es un overlay
    // flotando encima del lienzo -- pedido explícito: "no debe de impedir
    // ver el producto". Ahora es un bloque en flujo normal, debajo de esta
    // barra, que EMPUJA el lienzo hacia abajo en vez de taparlo -- el
    // producto completo (incluido el logo que se está editando) sigue
    // siempre visible mientras se ajusta cualquier control. Por eso todo
    // el componente envuelve en este div propio (antes la barra ERA el
    // elemento raíz) -- el ref del click-outside vive aquí, afuera, para
    // cubrir tanto el botón disparador como el panel.
    <div ref={optionsRef}>
