...
export default function FavoritoProductCard({ product, priceTiers, index = 0 }: Props) {
  ...
  return (
    <div
      className={`flex flex-col overflow-hidden rounded-[10px] bg-white shadow-[0_4px_25px_rgba(0,0,0,0.12)] [transition-property:opacity,transform,box-shadow] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-[8px] hover:scale-[1.02] hover:shadow-[0_20px_45px_rgba(0,0,0,0.18)] ${
