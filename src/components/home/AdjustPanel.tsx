...
// Panel temporal de ajuste visual para todo el contenido interno de la tarjeta "Experiencia"
// (destello, ícono, título, párrafo y botón). Eliminar este archivo y su uso en page.tsx
// cuando el usuario termine de ajustar.
type Box = { top: number; left: number; width: number; height: number };

const TARGETS = ["exp-glow", "exp-icon", "exp-heading", "exp-paragraph", "exp-button"] as const;
const LABELS = ["Destello", "Ícono", "Título", "Párrafo", "Botón"];

const INITIAL: Record<(typeof TARGETS)[number], Box> = {
  "exp-glow": { top: -7, left: 15, width: 162, height: 506 },
  "exp-icon": { top: 17, left: 56, width: 68, height: 113 },
  "exp-heading": { top: 88, left: 150, width: 433, height: 128 },
  "exp-paragraph": { top: 226, left: 146, width: 439, height: 61 },
  "exp-button": { top: 313, left: 267, width: 275, height: 76 },
};
