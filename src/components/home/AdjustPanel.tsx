...
const initial: Box = { top: -114, left: 30, width: 998, height: 447, scale: 1.22 };
...
export default function AdjustPanel() {
  ...
  return (
    ...
    >
      <div style={{ fontWeight: 700, marginBottom: 10, fontSize: 13 }}>Ajuste Rectángulo Blanco (fondo)</div>
