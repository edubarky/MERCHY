...
// rectángulo/contenedor completo y el área de formulario (tarjeta blanca).
// Eliminar este archivo y su uso en page.tsx cuando el usuario termine de ajustar.
type Box = { top: number; left: number; width: number; height: number };

const TARGETS = ["ctc-panel", "ctc-right"] as const;

const LABELS = ["Rectángulo (contenedor)", "Área de formulario"];

const INITIAL: Record<(typeof TARGETS)[number], Box> = {
  "ctc-panel": { top: -45, left: 134, width: 1026, height: 410 },
  "ctc-right": { top: 29, left: 381, width: 535, height: 331 },
};
