...
const TARGET = "ftr-rect";

type Box = { top: number; left: number; width: number; height: number };

const initial: Box = { top: 0, left: 0, width: 1400, height: 564 };
...
export default function AdjustPanel() {
  ...
  return (
    ...
    >
      <div style={{ fontWeight: 700, marginBottom: 10, fontSize: 13 }}>Ajuste Fondo Blanco Footer</div>
      {field("Top", "top", -400, 800)}
